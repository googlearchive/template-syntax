define(['dart_sdk', 'packages/angular/angular.template', 'packages/template_syntax/app_component.template', 'packages/angular/src/platform/bootstrap', 'packages/template_syntax/app_component'], function(dart_sdk, angular, app_component, bootstrap, app_component$) {
  'use strict';
