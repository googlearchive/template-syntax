define(['dart_sdk', 'packages/angular_components/utils/rate_limit_utils/rate_limit_utils.template', 'packages/angular_components/src/utils/async/rate_limit.template'], function(dart_sdk, rate_limit_utils, rate_limit) {
  ...
  dart.fn(src__utils__async__throttle_stream$46template.initReflector, VoidTovoid());
  dart.trackLibraries("packages/angular_components/src/utils/async/throttle_stream.template.ddc", {
    "package:angular_components/src/utils/async/throttle_stream.template.dart": src__utils__async__throttle_stream$46template
  }, '{"version":3,"sourceRoot":"","sources":["throttle_stream.template.dart"],"names":[],"mappings":";;;;;;;;;;;MAaI,sDAAQ;YAAG;;;;;AAEb,kBAAI,sDAAQ,GAAE;AACZ;;AAEF,6DAAW;AAEX,IAAM,kEAAa;AACnB,IAAM,sDAAa;EACrB","file":"throttle_stream.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=throttle_stream.template.ddc.js.map
