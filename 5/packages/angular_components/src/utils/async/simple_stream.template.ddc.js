define(['dart_sdk'], function(dart_sdk) {
  ...
  dart.fn(src__utils__async__simple_stream$46template.initReflector, VoidTovoid());
  dart.trackLibraries("packages/angular_components/src/utils/async/simple_stream.template.ddc", {
    "package:angular_components/src/utils/async/simple_stream.template.dart": src__utils__async__simple_stream$46template
  }, '{"version":3,"sourceRoot":"","sources":["simple_stream.template.dart"],"names":[],"mappings":";;;;;;;;;EAUsB","file":"simple_stream.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=simple_stream.template.ddc.js.map
