...
import 'dart:core';
import '../laminate/enums/alignment.dart' as import19;
...
class ViewMenuPopupComponent0 extends AppView<import2.MenuPopupComponent> {
  ...
  dynamic get _PopupRef_1_8 {
    if ((this.__PopupRef_1_8 == null)) {
      (__PopupRef_1_8 = import6.getResolvedPopupRef(this._MaterialPopupComponent_1_6));
    }
    return this.__PopupRef_1_8;
  }
  ...
  ComponentRef<import2.MenuPopupComponent> build() {
    ...
    _DeferredContentDirective_4_7 = new import7.DeferredContentDirective(_appEl_4, _TemplateRef_4_6, _MaterialPopupComponent_1_6);
...
class _ViewMenuPopupComponent1 extends AppView<import2.MenuPopupComponent> {
  ...
  import27.MaterialListComponent _MaterialListComponent_0_4;
  import3.Element _el_2;
  import28.ViewMenuItemGroupsComponent0 _compView_2;
  import29.AutoFocusDirective _AutoFocusDirective_2_4;
  import30.MenuRootDirective _MenuRootDirective_2_5;
  dynamic _MenuRoot_2_6;
  import31.MenuItemGroupsComponent _MenuItemGroupsComponent_2_7;
  var _expr_0;
  var _expr_2;
  ...
  ComponentRef<import2.MenuPopupComponent> build() {
    ...
    addShimC(_el_0);
    _MaterialListComponent_0_4 = new import27.MaterialListComponent();
    ...
    addShimC(_el_2);
    _AutoFocusDirective_2_4 = new import29.AutoFocusDirective(_el_2, parentView.parentView.injectorGet(import32.DomService, parentView.viewData.parentIndex), parentView.parentView.injectorGet(import29.Focusable, parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import33.ModalComponent, parentView.viewData.parentIndex, null), (parentView as ViewMenuPopupComponent0)._PopupRef_1_8);
    _MenuRootDirective_2_5 = new import30.MenuRootDirective((parentView as ViewMenuPopupComponent0)._MaterialPopupComponent_1_6);
    _MenuRoot_2_6 = _MenuRootDirective_2_5;
    _MenuItemGroupsComponent_2_7 = new import31.MenuItemGroupsComponent(_MenuRoot_2_6, _compView_2.ref, (parentView as ViewMenuPopupComponent0)._MaterialPopupComponent_1_6, parentView.parentView.injectorGet(import34.IdGenerator, parentView.viewData.parentIndex, null));
    import3.Text _text_3 = new import3.Text('\n    ');
