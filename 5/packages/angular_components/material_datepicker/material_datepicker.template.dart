...
import 'package:angular_components/material_datepicker/date_input.template.dart' as _ref9;
import 'package:angular_components/material_datepicker/material_calendar_picker.template.dart' as _ref10;
import 'package:angular_components/material_datepicker/module.template.dart' as _ref11;
import 'package:angular_components/material_datepicker/range.template.dart' as _ref12;
import 'package:angular_components/material_input/material_input.template.dart' as _ref13;
import 'package:angular_components/material_list/material_list_item.template.dart' as _ref14;
...
import 'package:angular_components/material_select/material_select_item.template.dart' as _ref17;
import 'package:angular_components/mixins/focusable_mixin.template.dart' as _ref18;
import 'package:angular_components/model/date/date.template.dart' as _ref19;
import 'package:angular_components/utils/angular/properties/properties.template.dart' as _ref20;
...
import '../src/laminate/popup/popup_ref.dart' as import31;
import '../material_input/material_input.template.dart' as import32;
import '../material_input/deferred_validator.dart' as import33;
import '../material_input/material_input.dart' as import34;
import '../focus/focus.dart' as import35;
import 'date_input.dart' as import36;
import '../material_input/material_input_default_value_accessor.dart' as import37;
import 'material_calendar_picker.template.dart' as import38;
import 'material_calendar_picker.dart' as import39;
import 'package:angular/src/common/directives/ng_class.dart' as import40;
import '../utils/browser/dom_service/dom_service.dart' as import41;
import '../laminate/components/modal/modal.dart' as import42;
import 'package:quiver/time.dart' as import43;
import '../material_input/base_material_input.dart' as import44;
import 'package:angular/src/common/directives/ng_for.dart' as import45;
import '../material_select/material_select_item.template.dart' as import46;
import '../material_select/material_select_item.dart' as import47;
import '../material_select/activation_handler.dart' as import48;
import '../model/selection/selection_container.dart' as import49;
import '../model/ui/has_renderer.dart' as import50;
import 'range.dart' as import51;
...
class ViewMaterialDatepickerComponent0 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  import11.DeferredContentDirective _DeferredContentDirective_4_9;
  String _expr_1;
  bool _expr_2;
  String _expr_3;
  var _expr_5;
  ...
  ViewMaterialDatepickerComponent0(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    rootEl = import3.document.createElement('material-datepicker');
    _renderType ??= import15.appViewUtils.createRenderType('', ViewEncapsulation.Emulated, styles$MaterialDatepickerComponent);
  ...
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    addShimC(_el_0);
    _PopupSourceDirective_0_5 = new import4.PopupSourceDirective(parentView.injectorGet(import17.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import18.ReferenceDirective, viewData.parentIndex, null));
    ...
    _MaterialPopupComponent_3_8 = new import10.MaterialPopupComponent(parentView.injectorGet(import20.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import10.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import21.NgZone, viewData.parentIndex), parentView.injectorGet(import22.OverlayService, viewData.parentIndex), parentView.injectorGet(import23.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import24.OpaqueToken<List<import26.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import24.OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import27.PopupSizeProvider, viewData.parentIndex, null), _compView_3.ref, _appEl_3, new ElementRef(_el_3));
    var _anchor_4 = ngAnchor.clone(false);
    _appEl_4 = new ViewContainer(4, 3, this, _anchor_4);
    TemplateRef _TemplateRef_4_8 = new TemplateRef(_appEl_4, viewFactory_MaterialDatepickerComponent2);
    _DeferredContentDirective_4_9 = new import11.DeferredContentDirective(_appEl_4, _TemplateRef_4_8, _MaterialPopupComponent_3_8);
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import8.DropdownButtonComponent) && (2 == nodeIndex))) {
      return _DropdownButtonComponent_2_5;
    }
    if ((identical(token, import4.PopupSourceDirective) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
      return _PopupSourceDirective_0_5;
    }
    if ((((identical(token, import10.MaterialPopupComponent) || identical(token, import29.DeferredContentAware)) || identical(token, import30.DropdownHandle)) && ((3 <= nodeIndex) && (nodeIndex <= 4)))) {
      return _MaterialPopupComponent_3_8;
    }
    if ((identical(token, import31.PopupRef) && ((3 <= nodeIndex) && (nodeIndex <= 4)))) {
      return _PopupRef_3_10;
    }
    if ((identical(token, import20.PopupHierarchy) && ((3 <= nodeIndex) && (nodeIndex <= 4)))) {
  ...
  void detectChangesInternal() {
    ...
    if (_query_MaterialInputComponent_1_1_isDirty) {
      ctx.textInput = (_appEl_4.mapNestedViews((_ViewMaterialDatepickerComponent2 nestedView) {
        return [nestedView._MaterialInputComponent_4_6];
      }).isNotEmpty
          ? _appEl_4.mapNestedViews((_ViewMaterialDatepickerComponent2 nestedView) {
              return [nestedView._MaterialInputComponent_4_6];
            }).first
          : null);
...
class _ViewMaterialDatepickerComponent1 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  var _expr_0;
  _ViewMaterialDatepickerComponent1(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.EMBEDDED, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
...
class _ViewMaterialDatepickerComponent2 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  import32.ViewMaterialInputComponent0 _compView_4;
  import33.DeferredValidator _DeferredValidator_4_5;
  import34.MaterialInputComponent _MaterialInputComponent_4_6;
  import34.MaterialInputComponent _Focusable_4_7;
  import35.AutoFocusDirective _AutoFocusDirective_4_8;
  import36.DateInputDirective _DateInputDirective_4_9;
  import34.MaterialInputComponent _BaseMaterialInput_4_10;
  import37.MaterialInputDefaultValueAccessor _MaterialInputDefaultValueAccessor_4_11;
  List<dynamic> __NgValidators_4_12;
  ViewContainer _appEl_5;
  NgIf _NgIf_5_9;
  import3.Element _el_6;
  import38.ViewMaterialCalendarPickerComponent0 _compView_6;
  import39.MaterialCalendarPickerComponent _MaterialCalendarPickerComponent_6_5;
  import40.NgClass _NgClass_6_6;
  bool _expr_0;
  String _expr_2;
  bool _expr_3;
  var _expr_5;
  ...
  var _expr_13;
  var _expr_15;
  _ViewMaterialDatepickerComponent2(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.EMBEDDED, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewMaterialDatepickerComponent0._renderType;
  }
  ...
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    addShimC(_el_3);
    _compView_4 = new import32.ViewMaterialInputComponent0(this, 4);
    ...
    addShimC(_el_4);
    _DeferredValidator_4_5 = new import33.DeferredValidator();
    _MaterialInputComponent_4_6 = new import34.MaterialInputComponent('text', null, null, _compView_4.ref, _DeferredValidator_4_5);
    _Focusable_4_7 = _MaterialInputComponent_4_6;
    _AutoFocusDirective_4_8 = new import35.AutoFocusDirective(_el_4, parentView.parentView.injectorGet(import41.DomService, parentView.viewData.parentIndex), _Focusable_4_7, parentView.parentView.injectorGet(import42.ModalComponent, parentView.viewData.parentIndex, null), (parentView as ViewMaterialDatepickerComponent0)._PopupRef_3_10);
    _DateInputDirective_4_9 = new import36.DateInputDirective(parentView.parentView.injectorGet(const import24.OpaqueToken('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import43.Clock, parentView.viewData.parentIndex), _MaterialInputComponent_4_6);
    _BaseMaterialInput_4_10 = _MaterialInputComponent_4_6;
    _MaterialInputDefaultValueAccessor_4_11 = new import37.MaterialInputDefaultValueAccessor(_BaseMaterialInput_4_10, null);
    ...
    _compView_6 = new import38.ViewMaterialCalendarPickerComponent0(this, 6);
    _el_6 = _compView_6.rootEl;
    _el_0.append(_el_6);
    _el_6.className = 'calendar-picker';
    createAttr(_el_6, 'mode', 'single-date');
    addShimC(_el_6);
    _MaterialCalendarPickerComponent_6_5 = new import39.MaterialCalendarPickerComponent(parentView.parentView.injectorGet(const import24.OpaqueToken('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import43.Clock, parentView.viewData.parentIndex), 'single-date');
    _NgClass_6_6 = new import40.NgClass(_el_6);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import33.DeferredValidator) && (4 == nodeIndex))) {
      return _DeferredValidator_4_5;
    }
    if (((identical(token, import34.MaterialInputComponent) || identical(token, import18.ReferenceDirective)) && (4 == nodeIndex))) {
      return _MaterialInputComponent_4_6;
    }
    if ((identical(token, import35.Focusable) && (4 == nodeIndex))) {
      return _Focusable_4_7;
    }
    if ((identical(token, import36.DateInputDirective) && (4 == nodeIndex))) {
      return _DateInputDirective_4_9;
    }
    if ((identical(token, import44.BaseMaterialInput) && (4 == nodeIndex))) {
      return _BaseMaterialInput_4_10;
    }
    if ((identical(token, import37.MaterialInputDefaultValueAccessor) && (4 == nodeIndex))) {
      return _MaterialInputDefaultValueAccessor_4_11;
    }
    if ((identical(token, const import24.MultiToken('NgValidators')) && (4 == nodeIndex))) {
      return _NgValidators_4_12;
    }
    if ((identical(token, import39.MaterialCalendarPickerComponent) && (6 == nodeIndex))) {
      return _MaterialCalendarPickerComponent_6_5;
    }
    return notFoundResult;
  }
...
class _ViewMaterialDatepickerComponent3 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  import3.Text _text_1;
  var _expr_0;
  _ViewMaterialDatepickerComponent3(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.EMBEDDED, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewMaterialDatepickerComponent0._renderType;
  }
  @override
  ComponentRef<import2.MaterialDatepickerComponent> build() {
...
class _ViewMaterialDatepickerComponent4 extends AppView<import2.MaterialDatepickerComponent> {
  import3.DivElement _el_0;
  ViewContainer _appEl_1;
  import45.NgFor _NgFor_1_9;
  var _expr_0;
  _ViewMaterialDatepickerComponent4(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.EMBEDDED, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewMaterialDatepickerComponent0._renderType;
  }
  @override
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    _NgFor_1_9 = new import45.NgFor(_appEl_1, _TemplateRef_1_8);
    init0(_el_0);
    return null;
  }
...
class _ViewMaterialDatepickerComponent5 extends AppView<import2.MaterialDatepickerComponent> {
  import3.Element _el_0;
  import46.ViewMaterialSelectItemComponent0 _compView_0;
  import47.MaterialSelectItemComponent _MaterialSelectItemComponent_0_5;
  import3.Text _text_1;
  var _expr_0;
  var _expr_2;
  _ViewMaterialDatepickerComponent5(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.EMBEDDED, {'\$implicit': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewMaterialDatepickerComponent0._renderType;
  }
  @override
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    _compView_0 = new import46.ViewMaterialSelectItemComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    createAttr(_el_0, 'closeOnActivate', 'false');
    addShimC(_el_0);
    _MaterialSelectItemComponent_0_5 = new import47.MaterialSelectItemComponent(_el_0, parentView.parentView.parentView.parentView.injectorGet(import41.DomService, parentView.parentView.parentView.viewData.parentIndex), (parentView.parentView.parentView as ViewMaterialDatepickerComponent0)._MaterialPopupComponent_3_8, parentView.parentView.parentView.parentView.injectorGet(import48.ActivationHandler, parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref);
    _text_1 = new import3.Text('');
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import47.MaterialSelectItemComponent) || identical(token, import49.SelectionItem)) || identical(token, import50.HasRenderer)) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
  ...
  void detectChangesInternal() {
    final import2.MaterialDatepickerComponent _ctx = ctx;
    bool firstCheck = (this.cdState == 0);
    final import51.SingleDayRange local_presetDate = locals['\$implicit'];
    if (firstCheck) {
    ...
    final currVal_2 = import15.interpolate0(local_presetDate.title);
    if (!identical(_expr_2, currVal_2)) {
...
class _ViewMaterialDatepickerComponentHost0 extends AppView<dynamic> {
  ...
  _ViewMaterialDatepickerComponentHost0(AppView<dynamic> parentView, int parentIndex) : super(import13.ViewType.HOST, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways);
  @override
  ComponentRef build() {
    _compView_0 = new ViewMaterialDatepickerComponent0(this, 0);
    rootEl = _compView_0.rootEl;
    _MaterialDatepickerComponent_0_5 = new import2.MaterialDatepickerComponent(this.injectorGet(const import24.OpaqueToken('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null));
