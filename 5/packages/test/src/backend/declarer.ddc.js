define(['dart_sdk', 'packages/collection/src/empty_unmodifiable_set', 'packages/collection/src/union_set', 'packages/async/src/future_group', 'packages/async/src/async_memoizer', 'packages/test/src/backend/state', 'packages/test/src/runner/configuration/runtime_selection', 'packages/boolean_selector/boolean_selector', 'packages/test/src/backend/platform_selector', 'packages/collection/src/functions', 'packages/test/src/backend/runtime', 'packages/source_span/src/span_exception', 'packages/test/src/frontend/timeout', 'packages/test/src/backend/suite_platform', 'packages/stream_channel/src/close_guarantee_channel', 'packages/test/src/runner/environment', 'packages/pool/pool', 'packages/async/src/stream_group', 'packages/collection/src/union_set_controller', 'packages/collection/src/queue_list', 'packages/async/src/delegate/sink', 'packages/test/src/util/iterable_set', 'packages/test/src/backend/message', 'packages/path/path', 'packages/test/src/runner/reporter', 'packages/test/src/util/placeholder', 'packages/matcher/src/core_matchers', 'packages/matcher/src/interfaces', 'packages/matcher/src/operator_matchers', 'packages/async/async', 'packages/matcher/src/error_matchers', 'packages/stack_trace/src/chain', 'packages/async/src/stream_sink_transformer', 'packages/test/src/util/stack_trace_mapper', 'packages/async/src/result/capture_sink', 'packages/test/src/frontend/utils', 'packages/test/src/runner/plugin/environment', 'packages/test/src/backend/operating_system', 'packages/test/src/backend/closed_exception', 'packages/test/src/backend/outstanding_callback_counter', 'packages/term_glyph/src/generated', 'packages/test/src/frontend/skip'], function(dart_sdk, empty_unmodifiable_set, union_set, future_group, async_memoizer, state, runtime_selection, boolean_selector, platform_selector, functions, runtime, span_exception, timeout, suite_platform, close_guarantee_channel, environment, pool, stream_group, union_set_controller, queue_list, sink, iterable_set, message, path, reporter, placeholder, core_matchers, interfaces, operator_matchers, async, error_matchers, chain, stream_sink_transformer, stack_trace_mapper, capture_sink, utils, environment$, operating_system, closed_exception, outstanding_callback_counter, generated, skip) {
  'use strict';
  ...
  src__runner__configuration__suite.SuiteConfiguration = class SuiteConfiguration extends core.Object {
    ...
    get runtimes() {
      return this[_runtimes] == null ? const$0 || (const$0 = dart.constList(["vm"], core.String)) : ListOfString().unmodifiable(this[_runtimes][$map](dart.dynamic, dart.fn(runtime => runtime.name, RuntimeSelectionToString())));
    }
    get includeTags() {
  ...
  (src__runner__configuration__suite.SuiteConfiguration.__ = function(opts) {
    ...
    this[dart2jsArgs$] = l != null ? l : const$ || (const$ = dart.constList([], core.String));
    ...
    [_runSkippedTest](suiteController, test, parents) {
      return async$.async(dart.dynamic, (function* _runSkippedTest() {
        ...
        controller = new src__backend__live_test_controller.LiveTestController.new(suiteController.liveSuite.suite, skipped, dart.fn(() => {
          dart.dsend(controller, 'setState', const$1 || (const$1 = dart.const(new src__backend__state.State.new(src__backend__state.Status.running, src__backend__state.Result.success))));
          dart.dsend(controller, 'setState', const$2 || (const$2 = dart.const(new src__backend__state.State.new(src__backend__state.Status.running, src__backend__state.Result.skipped))));
          if (skipped.metadata.skipReason != null) {
            dart.dsend(controller, 'message', new src__backend__message.Message.skip(dart.str`Skip: ${skipped.metadata.skipReason}`));
          }
          dart.dsend(controller, 'setState', const$3 || (const$3 = dart.const(new src__backend__state.State.new(src__backend__state.Status.complete, src__backend__state.Result.skipped))));
  ...
  src__frontend__expect_async._ExpectedFunction$ = dart.generic(T => {
    class _ExpectedFunction extends core.Object {
      get [_invoker]() {
        return src__backend__invoker.Invoker._check(this[_zone]._get(const$4 || (const$4 = dart.const(core.Symbol.new('test.invoker')))));
      }
  ...
  src__frontend__spawn_hybrid._spawn = function(uri, message, opts) {
    let stayAlive = opts && 'stayAlive' in opts ? opts.stayAlive : false;
    let channel = src__multi_channel.MultiChannel.as(async$.Zone.current._get(const$5 || (const$5 = dart.const(core.Symbol.new('test.runner.test_channel')))));
    if (channel == null) {
  ...
  dart.copyProperties(test, {
    get _declarer() {
      ...
      async$.scheduleMicrotask(dart.fn(() => async$.async(core.Null, function*() {
        ...
        let success = (yield async$.runZoned(FutureOfbool(), dart.fn(() => src__backend__invoker.Invoker.guard(FutureOfbool(), dart.bind(engine, 'run')), VoidToFutureOfbool()), {zoneValues: new _js_helper.LinkedMap.from([const$7 || (const$7 = dart.const(core.Symbol.new('test.declarer'))), test._globalDeclarer])}));
  ...
  (src__runner__load_suite.LoadSuite._changeSuite = function(old, suiteAndZone) {
    this[environment$0] = const$9 || (const$9 = dart.const(new src__runner__plugin__environment.PluginEnvironment.new()));
    this[isDebugging] = false;
    this[onDebugging] = StreamControllerOfbool().new().stream;
    this[_suiteAndZone] = suiteAndZone;
  ...
  (src__runner__load_suite.LoadSuite._filtered = function(old, filtered) {
    this[environment$0] = const$10 || (const$10 = dart.const(new src__runner__plugin__environment.PluginEnvironment.new()));
    this[isDebugging] = false;
    this[onDebugging] = StreamControllerOfbool().new().stream;
    this[config$] = old.config;
  ...
  src__backend__declarer.Declarer = class Declarer extends core.Object {
    static get current() {
      return src__backend__declarer.Declarer._check(async$.Zone.current._get(const$12 || (const$12 = dart.const(core.Symbol.new('test.declarer')))));
    }
    declare(body) {
      return async$.runZoned(dart.dynamic, body, {zoneValues: new _js_helper.LinkedMap.from([const$13 || (const$13 = dart.const(core.Symbol.new('test.declarer'))), this])});
    }
    test(name, body, opts) {
      let testOn = opts && 'testOn' in opts ? opts.testOn : null;
      let timeout = opts && 'timeout' in opts ? opts.timeout : null;
      ...
      this[_entries][$add](new src__backend__invoker.LocalTest.new(this[_prefix](name), metadata, dart.fn(() => async$.async(core.Null, (function*() {
        ...
        yield async$.runZoned(async$.Future, dart.fn(() => src__backend__invoker.Invoker.current.waitForOutstandingCallbacks(dart.fn(() => async$.async(core.Null, (function*() {
          ...
          yield body();
        }).bind(this)), VoidToFutureOfNull())), VoidToFuture()), {zoneValues: new _js_helper.LinkedMap.from([const$14 || (const$14 = dart.const(core.Symbol.new('test.declarer'))), this])});
    ...
    get [_setUpAll]() {
      ...
      return new src__backend__invoker.LocalTest.new(this[_prefix]("(setUpAll)"), this[_metadata$], dart.fn(() => async$.runZoned(async$.Future, dart.fn(() => async$.Future.forEach(VoidTodynamic(), this[_setUpAlls], dart.fn(setUp => dart.dcall(setUp), dynamicTodynamic())), VoidToFuture()), {zoneValues: new _js_helper.LinkedMap.from([const$15 || (const$15 = dart.const(core.Symbol.new('test.declarer'))), this])}), VoidToFuture()), {trace: this[_setUpAllTrace], guarded: false, isScaffoldAll: true});
    }
    get [_tearDownAll]() {
      ...
      }).bind(this)), VoidToFutureOfNull())), VoidTodynamic()), {zoneValues: new _js_helper.LinkedMap.from([const$16 || (const$16 = dart.const(core.Symbol.new('test.declarer'))), this])}), VoidTodynamic()), {trace: this[_tearDownAllTrace], guarded: false, isScaffoldAll: true});
    }
  };
  (src__backend__declarer.Declarer.new = function(opts) {
    ...
    src__backend__declarer.Declarer.__.call(this, null, null, (() => {
      ...
      return l != null ? l : const$11 || (const$11 = dart.const(UnmodifiableSetViewOfString().empty()));
  ...
  (src__backend__live_test_controller.LiveTestController.new = function(suite, test, onRun, onClose, opts) {
    ...
    this[_state] = const$17 || (const$17 = dart.const(new src__backend__state.State.new(src__backend__state.Status.pending, src__backend__state.Result.success)));
  ...
  src__backend__invoker.Invoker = class Invoker extends core.Object {
    ...
    static get current() {
      return src__backend__invoker.Invoker._check(async$.Zone.current._get(const$18 || (const$18 = dart.const(core.Symbol.new('test.invoker')))));
    }
    static guard(T, callback) {
      return async$.runZoned(T, callback, {zoneSpecification: async$.ZoneSpecification.new({handleUncaughtError: dart.fn((self, _, zone, error, stackTrace) => {
            let invoker = zone._get(const$19 || (const$19 = dart.const(core.Symbol.new('test.invoker'))));
            if (invoker != null) {
    ...
    skip(message) {
      ...
      if (dart.test(this.liveTest.state.shouldBeDone)) {
        this[_controller$1].setState(const$20 || (const$20 = dart.const(new src__backend__state.State.new(src__backend__state.Status.complete, src__backend__state.Result.error))));
      ...
      this[_controller$1].setState(const$21 || (const$21 = dart.const(new src__backend__state.State.new(src__backend__state.Status.pending, src__backend__state.Result.skipped))));
    }
    ...
    [_handleError](zone, error, stackTrace) {
      if (stackTrace === void 0) stackTrace = null;
      if (!core.identical(this[_runCount], zone._get(const$22 || (const$22 = dart.const(core.Symbol.new('runCount')))))) return;
      ...
      if (!src__frontend__expect.TestFailure.is(error)) {
        ...
        this[_controller$1].setState(const$24 || (const$24 = dart.const(new src__backend__state.State.new(src__backend__state.Status.complete, src__backend__state.Result.failure))));
      }
    ...
    [_onRun$]() {
      this[_controller$1].setState(const$25 || (const$25 = dart.const(new src__backend__state.State.new(src__backend__state.Status.running, src__backend__state.Result.success))));
      ...
      src__chain.Chain.capture(core.Null, dart.fn(() => {
        this[_guardIfGuarded](dart.fn(() => {
          ...
          }).bind(this)), VoidToFutureOfNull()), {zoneValues: new _js_helper.LinkedMap.from([const$26 || (const$26 = dart.const(core.Symbol.new('test.invoker'))), this, this[_counterKey], outstandingCallbacksForBody, this[_closableKey], true, const$27 || (const$27 = dart.const(core.Symbol.new('runCount'))), this[_runCount]]), zoneSpecification: async$.ZoneSpecification.new({print: dart.fn((_, __, ___, line) => this[_print](line), ZoneAndZoneDelegateAndZone__Tovoid())})});
        }, VoidToNull()));
  ...
  dart.defineLazy(src__utils, {
    /*src__utils.lineSplitter*/get lineSplitter() {
      return StreamTransformerOfListOfint$String().new(dart.fn((stream, cancelOnError) => stream.transform(core.String, convert.UTF8.decoder).transform(core.String, const$28 || (const$28 = dart.const(new convert.LineSplitter.new()))).listen(null, {cancelOnError: cancelOnError}), StreamOfListOfintAndboolToStreamSubscriptionOfString()));
    },
  ...
  (src__backend__metadata.Metadata.__ = function(opts) {
    ...
    this[timeout$] = timeout == null ? const$29 || (const$29 = dart.const(new src__frontend__timeout.Timeout.factor(1))) : timeout;
    this[_skip] = skip;
    ...
    this[onPlatform$0] = onPlatform == null ? const$30 || (const$30 = dart.constMap(src__backend__platform_selector.PlatformSelector, src__backend__metadata.Metadata, [])) : new (UnmodifiableMapViewOfPlatformSelector$Metadata()).new(onPlatform);
    this[forTag$] = forTag == null ? const$31 || (const$31 = dart.constMap(boolean_selector$.BooleanSelector, src__backend__metadata.Metadata, [])) : new (UnmodifiableMapViewOfBooleanSelector$Metadata()).new(forTag);
  ...
  (src__backend__metadata.Metadata.parse = function(opts) {
    ...
    this[timeout$] = timeout == null ? const$32 || (const$32 = dart.const(new src__frontend__timeout.Timeout.factor(1))) : timeout;
    ...
    this[forTag$] = const$33 || (const$33 = dart.constMap(boolean_selector$.BooleanSelector, src__backend__metadata.Metadata, []));
